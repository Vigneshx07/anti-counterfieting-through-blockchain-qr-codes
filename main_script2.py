...
main = Tk()
main.title("Authentication of product & counterfeit elimination using blockchain based QR code")
...
font = ('times', 15, 'bold')
title = Label(main, text='Authentication of product & counterfeit elimination using blockchain based QR code')
